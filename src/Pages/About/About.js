  ...
  return (
    <div className='bg-[#1D1D1D] py-20'>
        ...
        <div className="flex flex-col lg:flex-row mx-auto max-w-7xl justify-center items-center px-6 lg:px-28 relative">
            ...
            <div data-aos="fade-down" className=" h-full lg:h-[550px] relative w-full px-10 lg:px-0 lg:w-[40%] rounded-sm z-10 overflow-hidden group">
            ...
            <div data-aos="fade-left" className="lg:w-[50%] w-full mx-auto lg:mx-0 bg-black p-5 md:p-10 lg:ml-[-5rem] z-20 text-gray-400 font-medium shadow-2xl rounded-sm">
