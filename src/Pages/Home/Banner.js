...
const Banner = () => {
  ...
  useEffect(() => {
    AOS.init({
      duration: 1000, // set the duration of animation
  ...
  return (
    ...
    <div className='banner'>
      <div className="flex flex-col lg:flex-row  h-[60vh] lg:h-[90vh] max-w-7xl w-full mx-auto justify-between ">
        <div data-aos="fade-right" className="content w-full lg:w-[48%] items-center flex flex-col h-full justify-center lg:items-start lg:my-auto lg:ml-10 ">
